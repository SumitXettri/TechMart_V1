    ...
    <main className="min-h-screen bg-slate-100 px-6 py-8 text-slate-900 md:px-10 lg:px-12">
      <div className="mx-auto max-w-4xl">
        <RouteShell
          ...
          title="Login"
          description="Login scaffold for email/password access, OAuth, remember-me sessions, and future 2FA flows."
        >
          <div className="grid gap-4 lg:grid-cols-[1fr_0.8fr]">
            <form className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
              <div className="grid gap-4">
                ...
                <label className="grid gap-2 text-sm font-medium text-slate-700">
                  Password
                  <input className="rounded-2xl border border-slate-300 bg-white px-4 py-3 outline-none ring-0 focus:border-teal-500" type="password" placeholder="Enter password" />
                </label>
                <button className="rounded-full bg-slate-950 px-5 py-3 text-sm font-semibold text-white">Sign in</button>
              </div>
            </form>
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5 text-sm text-slate-600">
              <p className="font-semibold text-slate-950">Authentication roadmap</p>
