      ...
      <main>
          ...
          <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1fr_0.8fr] lg:items-center lg:py-28">
            <div className="max-w-2xl">
              ...
              <p className="mt-7 max-w-xl text-lg leading-8 text-teal-50/75">
                Shop trusted products, compete in live auctions, and get every order delivered with clear tracking from checkout to your door.
              </p>
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <Link href="/products" className="inline-flex items-center justify-center rounded-xl bg-amber-400 px-6 py-3.5 text-sm font-bold text-slate-950 transition hover:bg-amber-300">
                  Explore products <span className="ml-2" aria-hidden="true">-&gt;</span>
                </Link>
                <Link href="/auctions" className="inline-flex items-center justify-center rounded-xl border border-white/20 px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-white/10">
            ...
            <div className="relative mx-auto w-full max-w-md">
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/15 bg-[#f3f1e9] p-5 text-slate-950 shadow-2xl">
                <div className="flex items-center justify-between text-xs font-bold uppercase tracking-[0.2em] text-teal-800">
                  <span>Featured drop</span><span>01 / 03</span>
                </div>
                <div className="mt-5 flex h-64 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-200 via-orange-100 to-teal-100">
                  <div className="text-center">
                    <div className="text-8xl drop-shadow-xl" aria-hidden="true">▣</div>
                    <p className="mt-4 text-sm font-bold text-teal-900">Smart tech, ready to move</p>
                  </div>
                </div>
                <div className="mt-5 flex items-end justify-between gap-4">
                  <div><p className="text-sm text-slate-500">Live auction</p><h2 className="mt-1 text-2xl font-black">Smartphone X13</h2></div>
                  <Link href="/auctions" className="rounded-lg bg-teal-800 px-4 py-2 text-xs font-bold text-white hover:bg-teal-700">Bid now</Link>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16 lg:py-20">
          <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
            <div><p className="text-sm font-bold uppercase tracking-[0.24em] text-teal-700">Why TechMart</p><h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950">Everything after the click matters.</h2></div>
            <Link href="/checkout" className="text-sm font-bold text-teal-700 hover:text-teal-900">See secure checkout -&gt;</Link>
          </div>
